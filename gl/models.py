...
class Groups(models.Model):
    ...
    persons = models.ManyToManyField(User, related_name='persons', verbose_name='Участники')
...
class Notes(models.Model):
    ...
    person = models.ForeignKey(User, on_delete=models.CASCADE, related_name='profile', verbose_name='Пользователь')
    done = models.BooleanField(default=False, verbose_name='Выполнено')
